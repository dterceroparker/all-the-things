...
import FlowerThings from './pages/FlowerThings/FlowerThings'
...
const App = () => {
  ...
  const mariesThings = [
    {
      name: "flowers",
      image: "https://imgs.xkcd.com/comics/flowers.png",  
      attributes: ["beautiful", "nature", "colorful", "unique"],
    },
  ]
  ...
  return (
    <Routes>
      ...
      />
      <Route
        path="/the-flower-things"
        element={<FlowerThings things={mariesThings} />}
      />
    </Routes>
  )
}
